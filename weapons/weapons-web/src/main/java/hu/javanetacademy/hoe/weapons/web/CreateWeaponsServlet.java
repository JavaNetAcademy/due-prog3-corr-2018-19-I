 ...
 * @author Richard
 */
@WebServlet(name = "CreateWeaponServlet", urlPatterns = {"/weapons/create"})
public class CreateWeaponsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/weapons/create.jsp").include(request, response);
    }
